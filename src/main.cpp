...
/* ----------------- declarations of functions implemented further down ----------------------------------------------*/
...
void service_process_debug(byte, byte);
...
int analogReadEnhanced(uint8_t);

void update_az_variable_outputs(byte);

int digitalReadEnhanced(uint8_t);

void submit_request(byte, byte, float, byte);

void brake_release(byte, byte);

void process_easycom_command(byte *, int, byte, char *);

void process_dcu_1_command(byte *, int, byte, byte, char *);

void process_yaesu_command(byte *, int, byte, char *);

void process_remote_slave_command(byte *, int, byte, char *);

byte process_backslash_command(byte [], int, byte, byte, char *, byte);
...
void analogWriteEnhanced(uint8_t, int);

void pinModeEnhanced(uint8_t, uint8_t);

void change_tracking(byte);
