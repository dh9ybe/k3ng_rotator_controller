...
#define AZIMUTH_CALIBRATION_FROM_ARRAY {0,91,183,276,362,440}            /* these are in "raw" degrees, i.e. when going east past 360 degrees, add 360 degrees*/
#define AZIMUTH_CALIBRATION_TO_ARRAY {0,90,180,270,360,440}
